__kernel void matrix_conv(__global int * a, __global int * b, __global int * c, int n)
{
...
__kernel void matrix_conv_shared(__global int * a, __global int * b, __global int * c, int n)
{
